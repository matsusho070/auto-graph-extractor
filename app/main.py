...
def main(use_cache, article_text):
    set_llm_cache(SQLiteCache(database_path=".langchain.db"))

    # Initialize Lang Smith
    client = Client()

    # llm = ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0.7, cache=use_cache)
    llm = ChatOpenAI(model_name="gpt-4-turbo-2024-04-09", temperature=0.7, cache=use_cache)
...
if __name__ == "__main__":
    ...
    main(not args.no_cache, article_text)